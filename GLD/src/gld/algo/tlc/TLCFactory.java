...
public class TLCFactory
{
	...
	protected static final String[] xmlNames = {
    	...
    	SL5TLC.shortXMLName,
    	SL6TLC.shortXMLName,
        ATAA_TLC.shortXMLName,
	};


	protected static final String[] categoryDescs = {"Simple Maths", "Complex Maths", "Longest Q-variants", "Reinforcement Learning", "RL Sarsa TLCs", "Genetic", "Neural Network","Swarm"};
	...
	public TLController getInstanceForLoad (int algoId) throws InfraException
	{
		switch (algoId) {
			...
			case RLSARSA6: return new SL6TLC(infra);
                        case ATAA : return new ATAA_TLC(infra);
		}
