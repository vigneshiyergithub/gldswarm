...
public abstract class GLDToolBar extends ToolBar implements ActionListener, ItemListener
{
	...
	public GLDToolBar(Controller c, boolean newicon) {
		...
		if (newicon) addButton("src/gld/images/new.gif", this, NEW);
		addButton("src/gld/images/open.gif", this, OPEN);
		addButton("src/gld/images/save.gif", this, SAVE);
    ...
    addSeparator();
    addButton("src/gld/images/center.gif", this, CENTER);
		addSeparator();

  	addButton("src/gld/images/scroll.gif", this, SCROLL);
  	addButton("src/gld/images/zoom.gif", this, ZOOM);
  	addButton("src/gld/images/select.gif", this, SELECT);
  	...
  	addButton("src/gld/images/config.gif", this, CONFIG);
  	
  	addSeparator();
  	
		addButton("src/gld/images/help.gif", this, HELP);
