...
public class SimToolBar extends GLDToolBar
{
	...
	protected void addTools() {
  	addButton("src/gld/images/edgenode.gif", this, EDGENODE);
  	
  	addSeparator();
  	
  	addButton("src/gld/images/step.gif", this, STEP);
  	addButton("src/gld/images/run.gif", this, RUN);
  	addButton("src/gld/images/pause.gif", this, PAUSE);
  	addButton("src/gld/images/stop.gif", this, STOP);
