...
public class TrackerFactory
{
	...
	*/
	...
	{
		Enumeration _enum = trackingControllers.elements();
		while(_enum.hasMoreElements())
			((TrackingController)_enum.nextElement()).closeWindow();
	}
	...
	public static void disableTrackerViews()
	{
		Enumeration _enum = trackingControllers.elements();
		while(_enum.hasMoreElements())
			((TrackingController)_enum.nextElement()).setViewEnabled(false);
	}
	...
	public static void resetTrackers()
	{
		Enumeration _enum = trackingControllers.elements();
		while(_enum.hasMoreElements())
			((TrackingController)_enum.nextElement()).reset();
	}
	...
	public static TrackingController[] getTrackingControllers()
	{
		...
		int i=0;
		while(_enum.hasMoreElements()) {
			tca[i] = ((TrackingController)_enum.nextElement());
			i++;
		}
		return tca;	
	}
